package com.alsharqi.ams.exception;



import com.alsharqi.ams.response.DefaultResponse;
...
public class DefaultExceptionHandler {
    ...
    public ResponseEntity<DefaultResponse> StringInsteadOfLong(NumberFormatException e){
        ...
        return new ResponseEntity<DefaultResponse>(response,HttpStatus.NOT_ACCEPTABLE); //---- as we do not requier field
    }
