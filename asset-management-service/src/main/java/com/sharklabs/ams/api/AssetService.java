    ...
    public AssetAndAssetGroupResponse getAssetAndAssetGroup (AssetAndAssetGroupRequest request) throws AccessDeniedException,ApplicationException{
        ...
        try{
            ...
            if(request.getQuery() != null && request.getQuery() != ""){
                LOGGER.info("Inside service function of get Asset and Asset Group Query True.");
                ...
                response.setResponseIdentifier(SUCCESS);
                LOGGER.info("Inside service function of get Asset and Asset Group Query True."+convertToJSON(response));
            }
            if(request.getAssetUUIDs() != null && request.getAssetUUIDs().size()>0){
                ...
                response.setResponseIdentifier(SUCCESS);
                LOGGER.info("Inside service function of get Asset and Asset Group Query False."+convertToJSON(response));
